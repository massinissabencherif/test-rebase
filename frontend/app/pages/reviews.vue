  ...
  <div>
    ...
    <div class="max-w-[1100px] mx-auto px-6 py-8">
      ...
      <div v-else-if="!reviews.length" style="text-align:center;padding:80px 0;">
        ...
        <p style="font-family:impact,sans-serif;font-size:18px;letter-spacing:2px;text-transform:uppercase;color:#fff;margin-bottom:8px;">Aucun avis pour l'instant</p>
        <p style="font-family:'Courier New',monospace;font-size:12px;letter-spacing:2px;color:#fff;text-transform:uppercase;margin-bottom:24px;">Explore des comics et laisse tes premières notes.</p>
          ...
          <div class="flex gap-4">
            ...
            <NuxtLink :to="`/comics/${review.comic.externalId}`" class="shrink-0">
              <div style="width:60px;aspect-ratio:2/3;overflow:hidden;background:#1e1e1e;flex-shrink:0;transition:opacity 0.15s;" class="hover:opacity-80">
                <img
                  ...
                  loading="lazy"
                />
                <div v-else style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:24px;color:#fff;">📚</div>
              </div>
            </NuxtLink>
            ...
            <div class="flex-1 min-w-0">
              ...
              <template v-if="editingId !== review.id">
                ...
                <!-- Texte -->
                <p v-if="review.content" style="font-family:'Courier New',monospace;font-size:13px;line-height:1.7;color:#fff;margin-bottom:12px;">
                  {{ review.content }}
                </p>
                <p v-else style="font-family:'Courier New',monospace;font-size:12px;letter-spacing:1px;color:#fff;font-style:italic;margin-bottom:12px;">Aucun commentaire</p>
              ...
              <template v-else>
                ...
                <div v-if="editError" style="font-family:'Courier New',monospace;font-size:12px;letter-spacing:1px;color:#e02020;margin-bottom:10px;">{{ editError }}</div>
                ...
                <div class="flex items-center gap-3">
                  ...
                  <button
                    ...
                    style="font-family:'Courier New',monospace;font-size:11px;letter-spacing:2px;text-transform:uppercase;color:#fff;background:none;border:none;cursor:pointer;transition:color 0.15s;"
      ...
      <div v-if="reviews.length" style="margin-top:40px;padding-top:28px;border-top:1px solid #2a2a2a;display:flex;flex-wrap:wrap;gap:40px;">
        <div style="text-align:center;">
          ...
          <div style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:3px;text-transform:uppercase;color:#fff;margin-top:4px;">Comics notés</div>
        </div>
        <div style="text-align:center;">
          <div style="font-family:impact,sans-serif;font-size:28px;letter-spacing:1px;color:#fbbf24;">{{ avgRating }}</div>
          <div style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:3px;text-transform:uppercase;color:#fff;margin-top:4px;">Note moyenne</div>
        </div>
        <div style="text-align:center;">
          <div style="font-family:impact,sans-serif;font-size:28px;letter-spacing:1px;color:#fff;">{{ fiveStars }}</div>
          <div style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:3px;text-transform:uppercase;color:#fff;margin-top:4px;">5 étoiles</div>
        </div>
      </div>
    </div>
  </div>
