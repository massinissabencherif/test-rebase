      ...
      <div class="card">
        ...
        <div style="padding:28px;">
          <template v-if="sent">
            ...
            <p style="font-family:'Courier New',monospace;font-size:12px;letter-spacing:1px;color:#fff;line-height:1.6;margin-top:16px;">
          ...
          <template v-else>
            ...
            <p style="font-family:'Courier New',monospace;font-size:11px;letter-spacing:3px;color:#fff;text-transform:uppercase;margin-bottom:28px;">On t'envoie un lien de réinitialisation</p>

            <form @submit.prevent="submit" aria-label="Demande de réinitialisation">
              <div style="margin-bottom:20px;">
                <label for="forgot-email" style="display:block;font-family:'Courier New',monospace;font-size:10px;letter-spacing:4px;color:#fff;text-transform:uppercase;margin-bottom:8px;">Email</label>
        ...
        <!-- Footer -->
        <div style="padding:14px 28px;border-top:1px solid #1e1e1e;text-align:center;font-family:'Courier New',monospace;font-size:12px;color:#fff;">
